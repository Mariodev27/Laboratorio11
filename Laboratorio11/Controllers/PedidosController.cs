...
namespace Laboratorio11.Controllers
{
    public class PedidosController : Controller
    {
        ...
        {
            var pedidos = db.Pedidos.Include(p => p.clientes).Include(p => p.compa_iasdeenvios).Include(p => p.Empleados);
        ...
        {
            ViewBag.IdCliente = new SelectList(db.clientes, "idCliente", "NombreCompa_ia");
            ViewBag.FormaEnvio = new SelectList(db.compa_iasdeenvios, "idCompa_iaEnvios", "nombreCompa_ia");
        ...
        public ActionResult Create([Bind(Include = "IdPedido,IdCliente,IdEmpleado,FechaPedido,FechaEntrega,FechaEnvio,FormaEnvio,Cargo,Destinatario,DireccionDestinatario,CiudadDestinatario,RegionDestinatario,CodPostalDestinatario,PaisDestinatario")] Pedidos pedidos)
        {
            ...
            ViewBag.IdCliente = new SelectList(db.clientes, "idCliente", "NombreCompa_ia", pedidos.IdCliente);
            ViewBag.FormaEnvio = new SelectList(db.compa_iasdeenvios, "idCompa_iaEnvios", "nombreCompa_ia", pedidos.FormaEnvio);
